...
\pagestyle{fancy} 
\fancyhead{} 
\fancyfoot[L]{24 heures de l'INSA - Dossier sécurité - 44\up{ème} édition} 
\fancyfoot[C]{}
\fancyfoot[R]{\thepage}
...
\multicolumn{4}{|c}{\centering\includegraphics[height=4cm]{images/Trombi_orgas/Orga_secu_1}}  & \multicolumn{4}{c}{\includegraphics[height=4cm]{images/Trombi_orgas/Orga_secu_2}} & \multicolumn{4}{c|}{\includegraphics[height=4cm]{images/Trombi_orgas/Orga_secu_3}} \\
...
\multicolumn{3}{|c|}{\includegraphics[height=4cm]{images/Trombi_orgas/Tresorier}} & \multicolumn{3}{c|}{\includegraphics[height=4cm]{images/Trombi_orgas/Orga_billetterie}} & \multicolumn{3}{c}{\includegraphics[height=4cm]{images/Trombi_orgas/Orga_catering_1}} & \multicolumn{3}{c|}{\includegraphics[height=4cm]{images/Trombi_orgas/Orga_catering_2}}\\
...
\multicolumn{3}{|c}{\includegraphics[height=4cm]{images/Trombi_orgas/Orga_humain_1}} & \multicolumn{3}{c|}{\includegraphics[height=4cm]{images/Trombi_orgas/Orga_humain_2}} & \multicolumn{3}{c}{\includegraphics[height=4cm]{images/Trombi_orgas/Orga_bar_1}} & \multicolumn{3}{c|}{\includegraphics[height=4cm]{images/Trombi_orgas/Orga_bar_2}}\\
...
\multicolumn{3}{|c}{\rule{0pt}{2ex}} & \multicolumn{3}{c|}{} & \multicolumn{3}{c}{} & \multicolumn{3}{c|}{} \\
\multicolumn{3}{|c}{\includegraphics[height=4cm]{images/Trombi_orgas/Orga_barriere_1}} & \multicolumn{3}{c|}{\includegraphics[height=4cm]{images/Trombi_orgas/Orga_barriere_2}} & \multicolumn{3}{c}{\includegraphics[height=4cm]{images/Trombi_orgas/Orga_signa}} & \multicolumn{3}{c|}{\includegraphics[height=4cm]{images/Trombi_orgas/Orga_deco}}\\
...
\multicolumn{4}{|m{5.33cm}}{\rule{0pt}{2ex}} & \multicolumn{4}{m{5.33cm}}{} & \multicolumn{4}{m{5.33cm}|}{} \\
\multicolumn{4}{|c}{\centering\includegraphics[height=4cm]{images/Trombi_orgas/Orga_log_1}}  & \multicolumn{4}{c}{\includegraphics[height=4cm]{images/Trombi_orgas/Orga_log_2}} & \multicolumn{4}{c|}{\includegraphics[height=4cm]{images/Trombi_orgas/Orga_log_3}} \\
...
\multicolumn{4}{|m{5.33cm}}{\rule{0pt}{2ex}} & \multicolumn{4}{m{5.33cm}}{} & \multicolumn{4}{m{5.33cm}|}{} \\
\multicolumn{4}{|c}{\centering\includegraphics[height=4cm]{images/Trombi_orgas/Orga_concert_1}}  & \multicolumn{4}{c}{\includegraphics[height=4cm]{images/Trombi_orgas/Orga_concert_2}} & \multicolumn{4}{c|}{\includegraphics[height=4cm]{images/Trombi_orgas/Orga_concert_3}} \\
...
La manifestation des «24 heures de l’INSA» est une manifestation étudiante qui fêtera cette année sa 44\up{e}  édition. \\\\
...
\begin{center}
	...
	\captionof{figure}{\label{refPlanERP}Plan de l'ERP édition 2017}
\end{center}
...
Lors de la manifestation des 18, 19 et 20 mai 2018, ces bâtiments seront vides d’effectif public, seuls le PC sécurité, le poste de secours ainsi que les loges des artistes seront dans ces locaux. 
...
\subsubsection{Dispositions spécifiques à l'espace Scène Root's}
...
\begin{center}
	\includegraphics[width=.8\textwidth,keepaspectratio]{images/SceneRoots}
	\captionof{figure}{Schéma 3D de la structure de la Scène Root's}
\end{center}

Les arches sont des cercles de 6 mètres de diamètre, espacé de 7 mètres. Le podium sera de 6 par 4 mètres, à une hateur de 80 cm. La hauteur totale sera de 4 mètres.\\

Au dessus du public seront tendues, à l'aide de six totems, des voilures en lycra ignifugé. Elles auront une fonction décorative. Les cinq totems périphériques feront 4 mètres de haut, seront en dehors de la zone accessible au public et lestés par des bloc en béton. Le sixième fera 6 mètres et se trouvera au centre, lesté par une embase lourde de 60 kg. Il sera aussi maintenu en place grâce à l'aubenage avec les autres totems. Afin d'empêcher au public de monter sur le totem accessible, des planches bloqueront l'accès aux barreaux sur une hauteur suffisante. 
...
\begin{list}{•}{}
	...
	\item le samedi \textbf{19} mai de \textbf{14h à 17h} et de \textbf{20h à 3h20}
	\item le dimanche \textbf{20} mai de \textbf{14h à 17h}
\end{list}
...
\begin{center}
	...
	\captionof{figure}{Implantation de l'animation "Scène Dub"}
\end{center}
...
Voir paragraphe \ref{InstallationsElectriques}.

\subparagraph*{Éclairage (Article P.A. 11):}\mbox{}\\

Voir paragraphe \ref{Eclairage}.
...
Une zone ERP réduite sera mise en place à partir de 20h00 dans la partie sud de la zone concerts.\\
...
Note : la scène de l’édition 2018 ne sera plus identique aux éditions précédentes. Afin d'agrandir la surface utile ainsi que la résistance au vent, nous ferons appel à un prestataire différent. La structure utilisée permettra ainsi une résistance au vent jusqu'à \textbf{110 km/h}.
\begin{center}
	\includegraphics[scale=0.40, angle=90]{Annexes/Images/scene1}
	\captionof{figure}{Grande scène perspective 3D}
\end{center}

\begin{center}
	\includegraphics[scale=0.45, angle=90]{Annexes/Images/scene2}
	\captionof{figure}{Grande scène perspective 3D - Arrière}
\end{center}

\begin{center}
	\includegraphics[scale=0.45, angle=90]{Annexes/Images/scene3}
	\captionof{figure}{Grande scène vue de dessus}
\end{center}
...
Du vendredi 18 mai à 18h au dimanche 20 mai à 23h59, la \textbf{procédure d’accès} au campus est la suivante (vous trouverez ci-après le plan des points de sécurité du campus) :
\begin{list}{•}{}
	...
	\item L’ensemble du barrièrage est levé lundi 21 mai à 00h, après la fin du feu d’artifice. Les blocs bétons obstruant les points d'accès 3 et 6 sont quant à eux retirés entre 00h et 01h le lundi 21 mai.
...
\begin{center}
	...
	\captionof{figure}{Second périmètre de sécurité}
\end{center}

Deux véhicules banalisés sont placés sur les deux voies d'accès à cette zone. Ces véhicules seront aussi gardés soit par un agent (pour le véhicule près du PS1), soit par un bénévole (pour l'autre véhicule). A l'intérieur de ce périmètre, il n'y aura aucun véhicule de stationné, et seul les services de secours et la police seront autorisés à rentrer.
...
Pour séparer le public de la scène des concerts, un dispositif de «crash barrières» est mis en place sur 18 mètres de large devant la grande scène, sur 7 mètres devant la scène Nord, et sur 6m devant la scène Root's. \\
...
Les comptoirs de boissons sont surveillés par un agent de sûreté au niveau de chaque accès  organisateurs. L’objectif est d’assurer la sûreté des serveurs, des caisses, des installations et des stocks.\\
...
\begin{center}
	...
	\captionof{figure}{Emplacement de la Drop Zone à partir du 21 mai 8h}
\end{center}
...
Cet organisateur sera présent le vendredi 18 mai de 20h à 04h, le samedi 19 mai de 20h à 4h et le dimanche 20 mai de 20h à minuit. \\
...
En \textbf{soirée}, la zone concerts est soumise à la réglementation ERP, décrite dans la partie «Sécurité Incendie» du présent dossier. 
...
\begin{center}
	...
	\captionof{figure}{\label{etapes_entrees}Entrée et sortie de la zone concerts}
\end{center}

Il est à noter que les agents de sûreté mobiles, les organisateurs munis de leur bracelet et les secouristes peuvent accéder à la zone depuis n’importe quel couloir, y compris la sortie, et autant de fois que nécessaire.\\
...
Les vendredi et samedi soir, le public pourra emprunter les navettes «Pleine Lune» des TCL. Celles-ci, au départ de l’arrêt Albert Einstein, proposent de ramener le public jusqu’à la place des Terreaux, toutes les heures à partir de la fin de service des tramway T1 et T4. Les premiers départs de tram T1 et T4 coincideront avec l'horaire de l'évacuation de la zone.
...
Le Club des 24 heures  de l’INSA, désigné par la suite «l’Organisation», organise le festival «les 24 heures de l’INSA», dont la quarante-quatrième édition a lieu les 18, 18 et 20 mai 2018 sur le Campus de Lyon Tech - La Doua, 20 avenue Albert Einstein, 69100 Villeurbanne.\\
...
Des parafoudres sont déjà en place sur les bâtiments autour de la zone concerts et limitent les risques. En cas d’orage, une combinaison des précautions liées au vent et à la pluie est mise en place. Les activités sensibles sont arrêtées. 
...
Bien que cette note de posture s'intéresse principalement aux évènements de forte affluence qui se déroulent pendant la période hivernale, les 24 heures de l'INSA tiennent compte des recommandations faites dans le cadre du plan Vigipirate, consultables dans les documents suivants :
\begin{list}{•}{}
...
En début d'année, l'ensemble des organisateurs suivent une formation aux premiers secours ainsi qu'une formation sécurité incendie dispensées par des organismes habilités. Ces formation sont également proposées à l'ensemble des membres actifs sous la forme du volontariat.\\
...
\begin{list}{•}{}
	\item Le campus est fermé à la circulation par arrêté du Directeur de l'INSA Lyon, du vendredi 18 mai 18h00 au lundi 22 mai 0h00. Des barrages gardés par des organisateurs bénévoles et des agents de sûreté sont installés au niveau de quatre des six voies de circulation permettant d'entrer sur le campus. Ceux ci sont munis d'une liaison radio permanente avec le PC Sécurité et ont pour consigne de ne laisser passer que les véhicules de secours ou les véhicules munis d'un laissez-passer délivré en amont par les responsables sécurité. La procédure mise en place pour les laissez-passer nécessite que le nom du conducteur ainsi que la plaque d'immatriculation du véhicule correspondent avec les informations obtenues en amont. Les deux voies n'étant pas gardées par des barrages sont condamnées par des plots en béton.
	Les voitures stationnées aux abords de la zone seront évacuées avant l'ouverture de la zone ERP.
...
\begin{list}{•}{}
	\item Comme indiqué section \ref{gestion_flux} page \pageref{gestion_flux}, le campus est fermé à la circulation par des barrages constitués de barrières de type Vauban et d'un véhicule de type utilitaire (en soirée uniquement), gardés par des organisateurs bénévoles équipés d'une liaison radio avec le PC Sécurité accompagnés d'un agent de sûreté (en soirée uniquement).
	\item En complément des barrages, deux véhicules seront positionnés en travers de la voie à l'Est et à l'Ouest de la zone billetterie. Un agent de sûreté sera en permance prêt à déplacer le véhicule pour ouvrir la voie aux secours ou aux autorités.
	...
	\item La zone ERP respecte les normes en vigeurs, elle est donc étanche aux intrusions grâce à un barriérage couplé au dispositif d'agent de sûreté et permet une évacuation rapide et dans toutes les directions.
...
\shrinkheight{1cm} 
  ...
  \parbox[t]{10cm}{- Les équipements et structures sont situés en zone sécurisé ou zone organisateur, hors de portée du public\\
 ...
 \hline
  ...
  \parbox[t]{10cm}{- La fille d'attente pour l'achat de billet sur place est séparée de celles pour l'accès au site.\\
  - Des agents de sûreté sont en poste aux abords et à l'intérieur des files d'attentes.\\
  - Les bénévoles, organisateurs et prestataires disposent de bracelets et/ou badge offrant différents niveaux d'accès.\\
  - Un briefing a lieu tous les jours en début de soirée en plus du briefing général qui a lieu la semaine précédant la manifestation.\\}
 \\
 \hline
  N° 6 &
  ...
  - Des palpations sont effectuées par des agents de sûreté avec le consentement de la personne concernée. En cas de refus la personne se verra refuser l'accès.\\
  - Des inspections visuels des sacs de petite contenance sont effectuées par des agents de sûreté avec le consentement de la personne concernée. En cas de refus la personne se verra refuser l'accès.\\}
 \\
 \hline
  N° 7 &
  \parbox[t]{4cm}{Assurer les communications internes} & 
  \parbox[t]{10cm}{- Des liaisons radio spécifiques sont mises en place pour communiquer avec les bénévoles, l'équipe d'agent de sûreté et les secouristes.\\
 ...
 \hline
  ...
  \parbox[t]{10cm}{- L'application SAIP est consulté en permanance pour recevoir et relayer des alertes}
 \\
 \hline 
\end{tabular}
\end{center}

 Cette liste n'est pas exhaustive et des actions supplémentaires peuvent être ajoutée dans l'optique de renforcer d'avantage la sécurité des festivaliers, bénévoles et prestataires.
...
\begin{tabular}{ | p{2cm} | p{2.5cm} | p{2.5cm} | p{5cm} | p{4cm} | }
\hline
...
- Le ou les blessés graves sont pris en charge par les secouristes et transférés à l'infirmerie. Après évaluation des blessures, les pompiers sont contactés pour évacuation vers la clinique du Tonkin ou l'hôpital Edouard Herriot.
 \\ \hline
	\cellcolor[gray]{0.9}Collisions avec les spectateurs traversant le circuit & Moyenne & Tracé de la course longeant la zone concerts & - Briefing complet des coureurs avant le départ de la course
...
\item Animations de sensisbilisation au handicap
\item Art de rue
...
\hline
	...
	Correspondant 24h & Pedro Guedes 07 83 70 31 77 \\ \hline
	Brève description de l'activité & Parcours d'obstacle et toboggans pour les enfants. \\ \hline
	Remarques & . \\ \hline
	Analyse de risques
...
\hline
	...
	Responsable de l'activité & Entreprise Scape'show 01 60 03 04 14 \\ \hline
	Correspondant 24h & Pedro Guedes 07 83 70 31 77 \\ \hline
	Brève description de l'activité & Combat entre deux participant sur une plateforme gonflable, le dernier partcicipant debout est vainqueur. \\ \hline
	Remarques & Une file d’attente sera créée à l’aide de barrières. L'animation se déroulera sous la supervision d'un encadrant bénévole. \\ \hline
	Analyse de risques
...
\hline
	...
	Responsable de l'activité & Entreprise Scape'show 01 60 03 04 14 \\ \hline
	Correspondant 24h & Pedro Guedes 07 83 70 31 77  \\ \hline
	Brève description de l'activité & Parcours d'obstacle gonflables de 25m pour les enfants. \\ \hline
	Remarques & Adapté aux enfants de tout âges\\ \hline
	Analyse de risques
...
\subsection{Spectacle Equestre}

\subsubsection{Fiche sécurité}
\begin{center}
\begin{tabular}{ | p{6cm} | p{10cm} | }
\hline
	\multicolumn{2}{|l|}{Spectacle Equestre}  \\ \hline
	Horaires & Samedi et dimanche 10h – 18h \\ \hline
	Lieu & Terrain de football stabilisé \\ \hline
	Commission & Culture \\ \hline
	Responsable de l'activité & Entreprise Equid’events 06 26 54 39 57 \\ \hline
	Correspondant 24h & Thibaud Poulain 06 95 08 73 85  \\ \hline
	Brève description de l'activité & Spectacle équestre éducatif sur les chevaux de combat. \\ \hline
	Remarques & zone du spectacle séparée du public par des barrières. \\ \hline
	Analyse de risques
	
Matériel et dispositions de sécurité & La zone du spectacle sera délimitées par des barrières Vauban. L'animation se déroulera sous la supervision de professionels de l'entreprise Equid'events. \\ \hline
\end{tabular}
...
L’animation se compose de d’une cage à grimper de 8m de haut avec une tyrolienne de 40m de long arrivant sur l’herbe. Les utilisateurs peuvent monter a l’aide de filet tout en étant assuré. Cette animation peut contenir 8 personnes en simultanées et est ouverte à tous.
...
L’exploitation sera assurée par un moniteur d’escalade diplomé d’état, avec l’assistance de trois organisateur des 24 heures de l’INSA. Le moniteur sera chargé d’assurer le bon déroulement de l’animation et de briefer le public. Il veillera également à la sécurité des utilisateurs. Le bénévole se chargera de la gestion des flux et de l’équipement. L’animation n'accueillera pas plus de huit utilisateurs à la fois, une file d’attente est installée à l’extérieur pour contenir la foule. Une zone d'exclusion sous la tyrolienne sera matérialisé à l'aide de barrières vauban.  \\
...
\captionof{figure}{Accès à la zone concerts depuis la station INSA - Einstein}
\end{center}
...
En outre, un panneau de signalisation à l’entrée permet de l’identifier et la structure est vérifiée par un organisme abilité.
...
\item La scène Root's se situe sur un parking et un vise un public encore plus restreint que la petite scène, les personnes à mobilité réduite ne seront pas gênées si elles souhaitent participer au concert.
\end{list}
...
Dans la continuité de l’édition 2014, les personnes à mobilité réduite auront à disposition des toilettes (et lavabos) adaptés. Elles seront situées au sud de la structure PMR pour voir les concerts de la grande scène, le tout en conformité avec la circulaire interministérielle DGUHC 2007-53 du 30/11/1997.\\
...
A venir.
%\begin{center}
%\includegraphics[scale=0.70]{images/autorisationUCBL}
...
\captionof{figure}{Fiche ERP du bâtiment «Freyssinet» (307)}
\end{center}
