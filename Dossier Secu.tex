...
De plus, \textbf{entre 20h et 05h} les vendredi et samedi soirs, le dispositif est complété par des \textbf{véhicules banalisés} placés en travers des voies d'accès (empêchant tout véhicule de forcer l'accès) et gardés constamment par un agent de sûreté préposés à la manoeuvre de ces véhicules pour libérer l'accès en cas de besoin.\\
...
Durant toute la manifestation, soit du vendredi 18h au lundi 00h, les lecteurs des badges d’accès aux bâtiments de cours et laboratoires sont désactivés. De plus, dans toutes les résidences universitaires du campus de Lyon Tech - La Doua, les ascenseurs sont désactivés.\\
